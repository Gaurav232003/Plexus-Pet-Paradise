...
import 'package:petcare/daycaredata.dart';
...
class _DayCareState extends State<DayCare> {
  Query ref = FirebaseDatabase.instance.reference().child('DayCare');
  ...
  //   final snapshot = await ref.child('DayCare').get();
  //   return snapshot;
  // }
...
Expanded(
              child: new FirebaseAnimatedList(
                  query: FirebaseDatabase.instance.reference().child("DayCare"),
