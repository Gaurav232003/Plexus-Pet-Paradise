...
import 'package:petcare/petparkdata.dart';
...
class PetPark extends StatefulWidget {
  @override
  State<PetPark> createState() => _PetParkState();
}

class _PetParkState extends State<PetPark> {
  Query ref = FirebaseDatabase.instance.reference().child('PetParks');
  ...
  //   final snapshot = await ref.child('PetPark').get();
  //   return snapshot;
  // }
...
Expanded(
              child: new FirebaseAnimatedList(
                  query: FirebaseDatabase.instance.reference().child("PetPark"),
