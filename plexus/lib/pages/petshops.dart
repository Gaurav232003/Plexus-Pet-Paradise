...
import 'package:petcare/petshopdata.dart';
...
class _PetShopState extends State<PetShop> {
  Query ref = FirebaseDatabase.instance.reference().child('PetShop');
  ...
  //   final snapshot = await ref.child('PetShop').get();
  //   return snapshot;
  // }
...
Expanded(
              child: new FirebaseAnimatedList(
                  query: FirebaseDatabase.instance.reference().child("PetShop"),
